...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Shaolin soccer</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/shaolinsoccer.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%" width="300px;" height="600px;">
                        <img src="filmsforsite/shaolinsoccer.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%" width="300px;" height="600px;">
                        <img src="filmsforsite/shaolinsoccer.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%" width="300px;" height="600px;">
                        <img src="filmsforsite/Shaolinsoccer.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%" width="300px;" height="600px;">
                    </div>
